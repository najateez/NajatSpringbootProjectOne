...
public class JasperReportController {
    ...
    //exp: localhost:8080/jasper/generateStudentReportQuestion9?obtainedMarks=30
    @RequestMapping(value = "jasper/generateStudentReportQuestion9", method = RequestMethod.GET)
    public String generateStudentReportQuestion9(@RequestParam Integer obtainedMarks) throws Exception {
        return jasperReportService.generateStudentReportQuestion9(obtainedMarks);
    }
